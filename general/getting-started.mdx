...
You can play with this example in the following [validate-field js](https://codesandbox.io/s/github/lemoncode/fonk/tree/master/examples/vanilla/js/validate-form) and [validate-form js](https://codesandbox.io/s/github/lemoncode/fonk/tree/master/examples/vanilla/js/validate-form).

The Typescript version: [validate-field ts](https://codesandbox.io/s/github/lemoncode/fonk/tree/master/examples/vanilla/ts/validate-form) and [validate-form ts](https://codesandbox.io/s/github/lemoncode/fonk/tree/master/examples/vanilla/ts/validate-form)
