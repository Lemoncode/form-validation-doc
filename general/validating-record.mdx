...
> This behavior is different to [ValidateField](/api#validatefield), because validate field is ove one field, validateRecord is over a list of records. you get success or stops the process
...
if the the total amount purchase is greater than 30 USD.
...
let's jump firing all the validation toghether [form validations](/validating-form)
