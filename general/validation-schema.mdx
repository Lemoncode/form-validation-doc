...
![validate-field-record-and-form](../gifs/validate-field-record-and-form.gif)
...
- [Vuejs JS](https://codesandbox.io/s/github/Lemoncode/fonk/tree/master/examples/vue/js/validate-field-record-and-form)
...
![custom-error-message](../gifs/custom-error-message.gif)
...
![nested-field](../gifs/nested-field.gif)
...
- [Vuejs JS](https://codesandbox.io/s/github/Lemoncode/fonk/tree/master/examples/vue/js/nested-field).
