...
- You can override the validation message just for a given ValidationSchema (for instance if you use
  the _pattern_ (regex) validator you may want for a specific field in a validation schema to return
...
Now that you have learn how to build synchronous custom validators is time to learn how to implement [asynchronous ustom valators](TODO).
