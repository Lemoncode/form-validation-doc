...
This could impact in a severe wat to the usability of the application, our backend developers have decided to implement system that will hit a cache, and provide
