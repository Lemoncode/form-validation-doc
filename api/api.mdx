...
You can find these examples in [fonk examples](https://github.com/Lemoncode/fonk/tree/master/examples/docs/api/field-validator).
...
You can find these examples in [fonk examples](https://github.com/Lemoncode/fonk/tree/master/examples/docs/api/record-validator).
