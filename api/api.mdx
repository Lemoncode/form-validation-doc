...
- **validator**: [field async validator](/api#field-asynchronous-validator) or [field sync validator](/api#field-synchronous-validator) validation function to apply. As syntactic sugar, you could provide an object with `validator` property.
...
![field-validator](../gifs/field-validator.gif)
...
![record-validator](../gifs/record-validator.gif)
...
![array](../gifs/formik/array-shopping-cart-validation.gif)

You can find this example in [javascript example](https://github.com/Lemoncode/fonk/tree/master/examples/vanilla/js/shopping-cart-array-validator).
...
![custom-validators](../gifs/validate-field.gif)
...
![async-validator](../gifs/async-validator.gif)
